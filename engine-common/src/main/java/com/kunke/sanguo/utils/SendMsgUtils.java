...
//    private static final String url = "https://smsapi.cn-north-4.myhuaweicloud.com:443/sms/batchSendSms/v1"; //APP接入地址(在控制台"应用管理"页面获取)+接口访问URI
    ...
    private static final String appKey = "iHkCSosjgn1KW32g7iC25W04A7V9"; //APP_Key
    private static final String appSecret = "zFaUBNT7POrkuwl8IwihHFysM276"; //APP_Secret

    private static final String sender = "8822102431452"; //国内短信签名通道号或国际/港澳台短信通道号
    private static final String templateId = "4ce1c00c993c4cd79107b5224bdac072"; //模板ID

    public static void main(String[] args) throws Exception {
        sendMsg("18588413909", "123456");
    }
...
//        String templateId = "8ff55eac1d0b478ab3c06c3c6a492300"; //模板ID
        ...
        //国际/港澳台短信不用关注该参数
        String signature = "深圳市柒分酒业有限公司"; //签名名称
